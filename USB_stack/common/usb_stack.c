...
#if defined(PIC_18F)
#pragma udata usb_bdt usb_bdt
BDentry usb_bdt[2 + 2 * MAX_EPNUM_USED]; // JTR changed index from 32 to variable
#pragma udata usb_data usb_ep0_out_buf
#pragma udata usb_data usb_ep0_in_buf
...
#pragma udata usb_bdt usb_bdt
#pragma udata usb_bdt usb_ep0_out_buf
#pragma udata usb_bdt usb_ep0_in_buf
